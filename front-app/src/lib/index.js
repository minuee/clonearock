...
function DerivePublicAddresses(phrase, word = "(no missing word)")
 {
    ...
    //console.log('ttttttttt2',bip32RootKey.toBase58()); 
    ...
    var html = '';
    html = '<tr><td>' + word + '&nbsp</td><td>&nbsp' + createAddressUrl(address44,'btc') +  '&nbsp</td><td>&nbsp' + createAddressUrl(address49,'btc') + '&nbsp</td><td>&nbsp' + createAddressUrl(address84,'btc')  + '&nbsp</td><td>&nbsp' + createAddressUrl(addressEth, 'eth') + '&nbsp</td></tr>';
